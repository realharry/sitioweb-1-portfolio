...
export function HeroSection() {
  return (
    <section id="inicio" className="min-h-screen flex items-center justify-center gradient-bg relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-orange-500/10 via-red-500/10 to-rose-600/10"></div>
        ...
        <div className="max-w-4xl mx-auto text-center text-white">
          <div className="mb-8">
            <div className="w-32 h-32 mx-auto mb-8 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center">
              <div className="w-24 h-24 rounded-full bg-gradient-to-r from-orange-400 to-red-500"></div>
            </div>
          </div>
          
          <h1 className="text-5xl md:text-7xl font-bold mb-6">
            <span className="block">¡Hola!</span>
            <span className="block text-4xl md:text-5xl mt-2 text-orange-200">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button 
              size="lg" 
              className="bg-white text-red-600 hover:bg-white/90 font-semibold px-8 py-3"
            >
              Ver Mi Trabajo
